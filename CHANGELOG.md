...
### 1.2.0
- BREAKING CHANGE! Split document models by country codes into separate packages to optimize SDK size. Add only model packages on classpath which you really need. Keep the rest out.
    ```
